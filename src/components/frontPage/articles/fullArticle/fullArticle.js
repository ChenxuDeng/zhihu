    ...
    const bar=<React.Fragment>
        <Slide in={props.fullArticle} direction={'up'}>
            <div className={classes.fixedBar}>
                ...
                <Button className={classes.iconButton} disableRipple style={{marginLeft:'auto'}} onClick={()=>{props.closeFullArticle();window.removeEventListener('scroll',scrollHandler)}}>
                    收起
        ...
        <React.Fragment>
            <div id={'article1'}>
                ...
                <div style={{display:'flex',alignItems:'center',marginTop:'20px',marginBottom:'10px'}}>
                    ...
                    <Button className={classes.iconButton} disableRipple style={{marginLeft:'auto'}} onClick={()=>{window.removeEventListener('scroll',scrollHandler);props.closeFullArticle()}}>
                        收起
                        <ExpandLessIcon style={{fontSize:'15px',marginRight:'6px'}}/>
                    </Button>
                </div>
